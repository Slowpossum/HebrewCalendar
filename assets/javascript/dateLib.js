...
function getMonth(month, year) {
 ...
 // Set top-level elements in monthObject
  var monthObject = {
    startDay: firstDay.dayOfWeek,        // Day of the week the month starts
 ...
 // Test driver code
monthObject = getMonth(4, 2019)
console.log('Day of week month starts: ' + monthObject.startDay)
console.log('Hebrew month:  ' + monthObject.hMonth + ' ' + monthObject.hYear)
console.log('Hebrew month in Hebrew:  ' + monthObject.hMonthHebrew + ' ' +
  monthObject.hYearHebrew)
for (var i = 1; i <= 30; ++i)
  console.log('hArray[' + i + ']:  ' +
  monthObject.hArray[i].hDay + ' ' +
  monthObject.hArray[i].hMonth + ' ' +
  monthObject.hArray[i].hYear + ' = ' +
